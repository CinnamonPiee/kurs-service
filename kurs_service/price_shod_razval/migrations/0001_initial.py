    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='price_shod_razval.priceshodrazvalcategory', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Цена',
