...
setupModalHandler('.add-to-order-service', '/order-service/add-modal', 'addToOrderServices');
setupModalHandler('.add-to-order-evacuation', '/evacuation/add-modal', 'addToOrderEvacuation');
setupModalHandler('.add-to-sale', '/order-discount/add-modal', 'addToOrderDiscount');
setupModalHandler('.add-to-special-price', '/order-special-price/add-modal', 'addToOrderSpecialPrice');
setupModalHandler('.add-to-price', '/order-price-maintenance/add-modal', 'addToOrderPriceMaintenance');
setupModalHandler('.add-to-price-tire-fitting', '/order-price-tire-fitting/add-modal', 'addToOrderPriceTireFitting');
